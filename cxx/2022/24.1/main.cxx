...
//    auto blizzards = l_blizz | r_blizz | u_blizz | d_blizz;
//    for (auto i : ranges::views::iota(std::size_t{0}, lines.size())) {
//        for (auto j : ranges::views::iota(std::size_t{0}, chunk_sz)) {
//            std::cout << blizzards[i * chunk_sz + j];
//        }
//        std::cout << std::endl;
//    }
...
//        for (auto i : ranges::views::iota(std::size_t{0}, lines.size())) {
//            for (auto j : ranges::views::iota(std::size_t{0}, chunk_sz)) {
//                if (positions[i * chunk_sz + j]) {
//                    std::cout << 'E';
//                } else {
//                char c = '.';
//                    if (u_blizz[i * chunk_sz + j]) {
//                        c = '^';
//                    } else if (d_blizz[i * chunk_sz + j]) {
//                        c = 'v';
//                    } else if (l_blizz[i * chunk_sz + j]) {
//                        c = '<';
//                    } else if (r_blizz[i * chunk_sz + j]) {
//                        c = '>';
//                    }
//                    auto n = u_blizz[i * chunk_sz + j] + d_blizz[i * chunk_sz + j] + l_blizz[i * chunk_sz + j] +
//                             r_blizz[i * chunk_sz + j];
//                    if (n <= 1) {
//                        std::cout << c;
//                    } else {
//                        std::cout << n;

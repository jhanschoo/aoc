...
int main() {
    ...
    auto [min_y, max_y] = ranges::minmax(elves | ranges::views::keys);
    auto [min_x, max_x] = ranges::minmax(elves | ranges::views::values);
    std::cout << (max_y - min_y + 1) * (max_x - min_x + 1) - static_cast<int>(elves.size()) << std::endl;
}
